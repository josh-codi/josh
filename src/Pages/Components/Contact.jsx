...
function Contact() {
  return (
    <div id='contact' className='w-full flex justify-center flex-col items-center my-20 lg:my-32 px-5 xs:px-10 sm:px-20 lg:px-32 xl:px-56'>
        ...
        <br /><br />
        <Button text={'Say Hello'} link={'https://google.com'}/>
    </div>
  )
}
